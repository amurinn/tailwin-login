...
const App = () => {
  ...
  return (
    <div className="bg-dark-brown dark:bg-dark-blue w-screen h-screen flex duration-1000 transition">
      <div className='bg-sun dark:bg-moon md:hidden w-[120px] aspect-square rounded-full absolute top-[162px] left-[312px] animate-moonAnimation cursor-pointer duration-1000 transition' onClick={changeTheme}></div>
      <Form />
